...
import { getDb, getGoogleToken, getRecentEmails, getUpcomingCalendarEvents, getTodayNotes, saveBriefing, logSync, saveEmail, saveCalendarEvent } from "./db";
  ...
  try {
    ...
    try {
      ...
      try {
        ...
        await saveBriefing(userId, content, now);
